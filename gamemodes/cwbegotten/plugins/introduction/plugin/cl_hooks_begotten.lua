...
flashs locaux = { "TUER", "CHAIR", "MEURS", "SALOPE", "PUTAIN", "COLD POP", "YUM CHUG", "CHASSEUR", "CHANTIAM", "POP", "PUTAIN", "TUER", "TUER", "GLAÇAGE", "GORE", "GUERRE", "VILLAGE", "BRÛLER", "POURRISSANT", "MOUCHES", "RANCE", "PAPE", "HIÉRARCHIE", "SOMBRE", "LUMIÈRE", "CAGE", "TORTURE", "DÉMEMBREMENT", "COUPE", "MUTILER", "SEIGNEUR", "ÉGLISE", "TOUR", "ITZUTAK", "BEGOTTEN", "MORT", "ENFER", "INFERNO", "LÉCHER", "TORDU", "TORDU DE PUTAIN", "CADAVRE", "FLAMME", "OUBLIÉ", }

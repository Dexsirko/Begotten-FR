local ITEM = Clockwork.item:New("bodygroup_base")
	...
	ITEM.description = "Un casque de fer sur une coiffe de fer évoquant un visage barbare, souvent porté par les hommes de la Garde."
...
local ITEM = Clockwork.item:New("bodygroup_base")
	...
	ITEM.bodyGroupVal = 6
	ITEM.headSuffix = "_hill";
	ITEM.description = "Une casquette en fourrure, maintenue par une ficelle de lin et une couture grossière. Chaude, mais offrant à peine une protection."
	ITEM.excludedFactions = {"Goreic Warrior"};
...
local ITEM = Clockwork.item:New("bodygroup_base")
	...
	ITEM.bodyGroupVal = 2
	ITEM.headSuffix = "_hill";
	ITEM.description = "Un casque de fer à visière ouverte offrant une meilleure visibilité. Souvent porté par les vétérans de la Garde."
	ITEM.excludedFactions = {"Goreic Warrior"};
	ITEM.useSound = "armor/plate_damage_02.wav";
	ITEM.overlay = "begotten/zomboverlay/gatekeep1";
...
local ITEM = Clockwork.item:New("bodygroup_base")
	...
	ITEM.bodyGroupVal = 3
	ITEM.headSuffix = "_hill";
	ITEM.description = "Un casque orné surmonté d'une parure en forme de serpent, avec une cagoule en mailles de fer couvrant entièrement le visage et protégeant l'ensemble du cou."
	ITEM.excludedFactions = {"Goreic Warrior"};
	ITEM.useSound = "armor/plate_damage_02.wav";
	ITEM.overlay = "begotten/zomboverlay/gatekeep1";
...
local ITEM = Clockwork.item:New("bodygroup_base")
	...
	ITEM.bodyGroupVal = 4
	ITEM.headSuffix = "_hill";
	ITEM.description = "Un casque épais avec une coiffe de mailles fendue, matelassée et faite d'acier."
	ITEM.excludedFactions = {"Goreic Warrior"};
	ITEM.useSound = "armor/plate_damage_02.wav";
	ITEM.overlay = "begotten/zomboverlay/gatekeep1";
	ITEM.requiredbeliefs = {"hauberk"};
...
local ITEM = Clockwork.item:New("bodygroup_base")
	...
	ITEM.bodyGroupVal = 5
	ITEM.headSuffix = "_hill";
	ITEM.description = "Un heaume à haute crête, couvert d'emblèmes runiques et de sigils du Gore-Glazic, avec une coiffe fendue. Le signe de la position ultime qu'un homme de la Garde pouvait atteindre."
	ITEM.useSound = "armor/plate_damage_02.wav";
	ITEM.overlay = "begotten/zomboverlay/gatekeep1";
...
local ITEM = Clockwork.item:New("bodygroup_base")
	...
	ITEM.bodyGroupVal = 7
	ITEM.headSuffix = "_hill";
	ITEM.description = "Une coiffe de lin avec un chapeau à larges bords, teinte en blanc. Elle protège la tête de la neige endémique du Nord."
	ITEM.useSound = "npc/combine_soldier/zipline_clothing2.wav";	
...
local ITEM = Clockwork.item:New("bodygroup_base")
	...
	ITEM.description = "Une représentation renfrognée de Saint Ragnar, un visage imposant destiné à inspirer la crainte aux païens. Sa grimace porte le regard de la mort et l'allégresse de la purification des Forêts de la Colline ; et, pour les infidèles, un rappel cinglant de la majesté complexe du visage Gore-Glazique. Elle est nouvellement forgée pour servir les nouveaux mystères exposés par les Castigateurs dans leur lutte contre les ténèbres."
	ITEM.requiredFactions = {"Holy Hierarchy"};
	ITEM.useSound = "armor/plate_damage_02.wav";
	ITEM.overlay = "begotten/zomboverlay/gatekeep1";
...
local ITEM = Clockwork.item:New("bodygroup_base")
	...
	ITEM.description = "Un objet grossier, stupide et maudit. Ceux qui osent le revêtir seront peut-être grandement récompensés."
...
local ITEM = Clockwork.item:New("bodygroup_base")
	...
	ITEM.bodyGroupVal = 8
	ITEM.headSuffix = "_hill";
	ITEM.description = "Une représentation abîmée d'un poulet. Quelque chose cloche vraiment avec celle-ci."
...
local ITEM = Clockwork.item:New("bodygroup_base")
	...
	ITEM.description = "Un heaume d'acier fin aux incrustations élégantes. Il affiche la richesse, mais son porteur est une âme haineuse. Cet accoutrement infâme est associé à la Grande Orthodoxie du Nord, une bande de fanatiques qui ont pillé et extorqué les pèlerins du Nord au nom de l'expiation et du remboursement de leurs dettes envers Sol. Il semble protégé par une aura de jugement qui provoque un grand malaise chez les pécheurs."
	ITEM.useSound = "armor/plate_damage_02.wav";
...
local ITEM = Clockwork.item:New("bodygroup_base")
	...
	ITEM.bodyGroupVal = 9
	ITEM.headSuffix = "_hill";
	ITEM.description = "Un casque de fer et de cuir porté par les hommes des Collines."
	ITEM.excludedFactions = {"Goreic Warrior"};
	ITEM.useSound = "armor/plate_damage_02.wav";
	ITEM.overlay = "begotten/zomboverlay/gatekeep1";
...
local ITEM = Clockwork.item:New("bodygroup_base")
	...
	ITEM.headSuffix = "_hill";
	ITEM.description = "Un casque en métal et cuir, généreusement rembourré de fourrures. Offre une excellente protection et maintient au chaud."
	ITEM.excludedFactions = {"Goreic Warrior"};
	ITEM.useSound = "npc/combine_soldier/zipline_clothing2.wav";

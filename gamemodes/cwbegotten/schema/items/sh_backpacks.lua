local ITEM = Clockwork.item:New("backpack_base");
	...
	ITEM.weight = 1;
	ITEM.invSpace = 8;
	ITEM.description = "Un vieux petit sac à dos de fabrication Glazic qui a miraculeusement résisté à l'épreuve du temps.";
...
local ITEM = Clockwork.item:New("backpack_base");
	...
	ITEM.weight = 2;
	ITEM.invSpace = 10;
	ITEM.description = "Un vieux sac à dos de taille moyenne, de fabrication Glazic, qui a miraculeusement résisté à l'épreuve du temps.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/"..ITEM.uniqueID..".png"
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine4";
...
local ITEM = Clockwork.item:New("backpack_base");
	...
	ITEM.weight = 3;
	ITEM.invSpace = 13;
	ITEM.description = "Un sac à dos de taille moyenne avec un assortiment de poches, il peut probablement contenir beaucoup de choses.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/"..ITEM.uniqueID..".png"
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine4";
...
local ITEM = Clockwork.item:New("backpack_base");
	...
	ITEM.weight = 4;
	ITEM.invSpace = 18;
	ITEM.description = "Un grand sac à dos offrant un espace de stockage considérable.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/"..ITEM.uniqueID..".png"
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine4";
	ITEM.attachmentOffsetAngles = Angle(90, 101, 0);
...
local ITEM = Clockwork.item:New("backpack_base");
	...
	ITEM.weight = 0.5;
	ITEM.invSpace = 5;
	ITEM.description = "Un petit sac artisanal idéal pour contenir de menus objets.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/"..ITEM.uniqueID..".png"
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine4";
...
local ITEM = Clockwork.item:New("backpack_base");
	...
	ITEM.weight = 3;
	ITEM.invSpace = 13;
	ITEM.description = "Un sac confectionné à partir de peaux animales, capable de contenir une quantité raisonnable d'objets.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/"..ITEM.uniqueID..".png"
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine4";
